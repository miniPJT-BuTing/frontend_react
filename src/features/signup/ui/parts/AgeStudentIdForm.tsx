...
export default function AgeStudentIdForm() {
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          placeholder="나이 (예: 20)"
          className="h-14 w-full rounded-xl border-2 border-gray-600 px-4 text-lg outline-none focus:bg-gray-50 transition-colors"
        />
      </div>
